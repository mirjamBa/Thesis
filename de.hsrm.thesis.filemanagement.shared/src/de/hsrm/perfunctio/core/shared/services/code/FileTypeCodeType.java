 ...
 * 
 * @see <a
 *      href="http://dublincore.org/documents/dcmi-type-vocabulary/">http://dublincore.org/documents/dcmi-type-vocabulary/</a>
...
public class FileTypeCodeType extends AbstractCodeType<Long> {
	...
	@Order(60.0)
	public static class InteractiveResourceCode
			extends
				AbstractDCMITypeVocabularyCode {
	...
	@Order(110.0)
	public static class PhysikalischesObjektCode
			extends
				AbstractDCMITypeVocabularyCode {
