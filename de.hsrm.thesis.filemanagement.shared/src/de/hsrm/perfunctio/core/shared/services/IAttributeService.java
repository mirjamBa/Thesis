...
public interface IAttributeService extends IService {
	 ...
	 * assigned file type id [attribute id, name, show_in_table, data type uid, file type id].
	 * If no filetypeId is given, all available attributes will be returned. If
	 * addGeneralAttr = true, all attributes for the assigned file type and all
	 * attributes without a file type will be returned
	 * 
	 * @param filetypeId
	 *            Long
	 * @param addGeneralAttr
	 *            boolean
	 * @return Object[][]
	 * @throws ProcessingException
	 */
