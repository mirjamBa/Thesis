  ...
  public class FileTable extends AbstractExtensibleTable {
    ...
    public class AuthorityMenu extends AbstractExtensibleMenu {
      ...
      protected void execAction() throws ProcessingException {
        ...
        form.getAuthorityBox().getRolesField().setValue(SERVICES.getService(IRoleProcessService.class).
            getApprovedRolesForFile(getFileIdColumn().getSelectedValue()));
    ...
    public class ModifyMenu extends AbstractExtensibleMenu {
      ...
      protected void execAction() throws ProcessingException {
        ...
        form.getTypistField().setEnabled(false);
        form.getFileTypeField().setValue(getFileTypeColumn().getSelectedValue());
        form.getFileTypeField().setEnabled(false);
        form.getAvailableTagsBox().setValue(SERVICES.getService(ITagService.class).getTagsForFile(getFileIdColumn().getSelectedValue()));
        form.getAuthorityBox().getRolesField().setValue(SERVICES.getService(IRoleProcessService.class).
            getApprovedRolesForFile(getFileIdColumn().getSelectedValue()));
