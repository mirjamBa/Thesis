...
public class RoleProcessService extends AbstractService
	...
	public RoleFormData create(RoleFormData formData)
		...
		SQL.insert(
				...
				new NVPair("roleId", roleId.getValue()), new NVPair(
						"permissions", formData.getPermissions().getValue()));
		return formData;
	}
	...
	public Long[] getApprovedRolesForFileOrFolder(Long fileId)
		...
		SQL.selectInto(
				"SELECT role_id FROM role_file_permission WHERE file_id = :fileId INTO :longArray",
